...
{
wget -N --no-check-certificate -q -O ~/histeria.sh https://raw.githubusercontent.com/reyluar018/pandavpnunite/main/histeria.sh; chmod +x ~/histeria.sh; ./histeria.sh --version v1.3.5
